...
export default function Footer() {
  return (
    <div className="w-full   bg-[#428897] dark:bg-yellowBackground flex flex-col  items-center pb-8 pt-10">
      ...
      <div className="flex flex-row flex-wrap justify-center md:pt-4 pb-4">
        <p className="text-white text-[10px] md:text-[20px] font-gilroy font-500 pl-3 md:px-3">About Minerva</p>
        <div class="flex items-center">
          <p className="text-white text-[10px] md:text-[20px] font-gilroy pl-3 md:px-3">About PES University</p>
        </div>
        <div class="flex items-center">
          <p className="text-white text-[10px] md:text-[20px] font-gilroy pl-3 pt-1 md:px-3">Newsletter</p>
        </div>
        <div class="flex items-center">
          <p className="text-white text-[10px] md:text-[20px] font-gilroy pl-3 pt-1 md:px-3">Privacy Policy</p>
        </div>
        <div class="flex items-center">
          <p className="text-white text-[10px] md:text-[20px] font-gilroy pl-3 pt-1 md:px-3">Terms & Conditions</p>
        </div>
      </div>
